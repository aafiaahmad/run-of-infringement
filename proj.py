...
def tavern_choice(inputed, fir, sec, choice1, choice1_1, choice1_2):
    ...
    if fir:
        time.sleep(0.5)
        return2 = yesno(choice1, "tavern_table_stealth.jpg", choice1_1, choice1_2, "tavern_table_stealth.jpg",
                        "tavern_table_stealth.jpg")
    elif sec:
        time.sleep(0.5)
...
def choice_strength(inputed, ab, fir, sec, choice1, choice1p2, choice1p3, choice2, choice2p2, choice2p3, a, b, c, d, e,
                    f):
    pygame.event.get()
    textput_wrap = textwrap.wrap(inputed, 65)
    fir = False
...
main_charismawitchp2 = '''“No,” you say loudly, trying to suppress the trembling in your voice. “Listen, I may be a witch, and you may hate me for that, but I am powerful. Surely my magic could be of some use to you.” The silence is painful, and you think they’ll go ahead and kill you all the same. Then the man speaks. “Actually, there is something you can do for us, witch. Slay the dragon that lives in the castle, and we will let you go on your way.” “All right,” you say. “I accept your terms.” Probable death is better than certain death, right?'''
main_charismawitchp3 = '''You turn to leave when you hear the man’s voice again. “One more thing. The amulet.” You hand it over readily, not willing to risk him rescinding the offer. Terrified, you take the first steps of what will likely be a fatal journey.'''
...
It lifts its head and startles you by speaking. “Don’t kill me,” it says calmly, its voice low and gravelly. “Why not?” you ask, trembling. “Many innocent people have perished because of you.”
...
time.sleep(0.5)
if stealth == True:
    bar_table, go_force = tavern_choice(main_tavern, fir, sec, main_tablestealth, main_tablestealth_yes,
                                        main_tablestealth_no)
...
if stealth == True:
    ...
    time.sleep(0.5)
    dummy = choice(stealth_dragon1p1, "Stealth2.jpg", fir, sec, stealth_dragon_chand, stealth_dragon_chand2,
                   stealth_dragon_chand3, stealth_dragon_dragon, "PRESS X TO END", "", "stealth4.jpg", "stealth4.jpg",
                   "stealth4.jpg", "boop.jpg", "boop.jpg", "boop.jpg")
    if dummy==1:
        sys.exit()
if strength == True:
    wake_up = choice(strength_dragon, "dungeonstrength.jpg", fir, sec, strength_dragon_sleep, strength_dragon_sleep2,
                   strength_dragon_sleep3, strength_dragon_wake, strength_dragon_wake2, strength_dragon_wake3,
                   "dungeonstrength.jpg", "dungeonstrength.jpg", "dungeonstrength.jpg", "dungeonstrength-3.jpg",
                   "dungeonstrength-7.jpg", "dungeonstrength-7.jpg")
    if wake_up==0:
        sys.exit()
if magic == True:
    mainstorydif(magic_dragon, "dungeonmagic.jpg")
