...
main_tablestrength = '''You head over to the table in the far corner of the room. After introducing yourself to the people in your vicinity, you order a hearty meal. They admire your armour and ask you about your travels.'''
main_tablestrength2 = '''You explain that you have seen more of the world than you ever wished to,
fearsome fauna and threatening terrain. Before long, you are the talk of the tavern, and everyone seems to have crowded around your table.''' 
...
main_barp1 = '''You stride to the bar and take the last seat. After introducing yourself to the bartender, you explain that you have traveled to many lands, seen many things. At a sudden pang of hunger, you order some food which you promptly devour. The bartender watches you with amusement. Belatedly, you realize that you don’t have any money. You sheepishly say as much when he asks for payment, thinking he might be lenient. '''
main_barp2 = '''Seemingly without any regard for what you just said, he tells you that a dragon has been terrorizing this town for many years. You look at him, baffled, until you realize his meaning. “Me? Kill a dragon? To pay for my food? You must be joking!” He stares at you solemnly, and you realize he’s dead serious. After an uncomfortable moment, you acquiesce. If the mission was that dangerous, he wouldn’t send you, right? '''
main_barp3 = '''Before you leave, he spots the golden amulet hanging around your neck. “That looks valuable,” he says. “Why don’t I hold on to it until you return?” Once more, you have no choice but to agree, and with that, he rudely shoves you out the door. Guess it’s time to kill a dragon. “Head to the castle!” he yells after you. Very helpful, isn’t he?'''

main_magicwitch = '''After an interminably long time, your attackers deposit you roughly in front of the tavern.
You are terrified to see a pyre set up outside. People flood out of the building, drinks in their hands and malice in their eyes. They start to herd you towards your fiery fate when a man barrels through the mob and tells you to run. You both dash away in the confusion, stopping only once there is no danger that they might find you. “Why did you save me?” you ask, wheezing. You’re more out of shape than you thought.'''
main_magicwitchp2 = '''“You are immensely powerful,” says the mysterious man. “There is a dragon that resides in a castle nearby, and it has brought nothing but destruction to this town. You must kill it.” “Me?” you sputter. “Kill a dragon?” “You have no choice,” he impresses. “Unless you want the mob to conveniently find you again.” “And here I thought you were a good person,” you say, stung. “But yes, I will try to kill this dragon.” He asks for your amulet as collateral, which annoys you even more, but you hand it over. He did save your life, after all. Ready to leave him behind, you begin your long journey to slay the dragon.'''
 
main_charismawitch = '''After an interminably long time, your attackers deposit you roughly in front of the tavern.
You are terrified to see a pyre set up outside. People flood out of the building, drinks in their hands and malice in their eyes. They start to herd you towards your fiery fate, but you stop in your tracks, hoping to buy yourself enough time to talk them out of burning you. “Move along,” a scowling man with blood stains on his clothing grumbles.'''
main_charismawitchp2 = '''“No,” you say loudly, trying to suppress the trembling in your voice. “Listen, I may be a witch, and you may hate me for that, but I am powerful. Surely my magic could be of some use to you.” The silence is painful, and you think they’ll go ahead and kill you all the same. Then the man speaks. “Actually, there is something you can do for us, witch. Slay the dragon that lives in the castle, and we will let you go on your way.” '''
main_charismawitchp3 = '''“All right,” you say. “I accept your terms.” Probable death is better than certain death, right? You turn to leave when you hear the man’s voice again. “One more thing. The amulet.” You hand it over readily, not willing to risk him rescinding the offer. Terrified, you take the first steps of what will likely be a fatal journey.'''
...
main_castle_2 = "Well, turning back is not an option. You will keep going, and you will slay that dragon. Probably. Maybe. You walk for what seems like hours. The stars shine brightly against the dark canvas of the sky, and you let yourself bask in the beautiful sight for a moment. "
main_castle_3 = "Then you have to bring your attention back to your surroundings, because before you is a deep canyon into which the path gradually slopes. Something in its very nature seems sinister and menacing, as though this valley might end you before the dragon does. But to circumvent the ravine would prolong your journey, when you just want this ordeal to be over as soon as possible. Plus, you have to conserve your strength for the real fight. So the canyon it is."

main_castle_stealth_1 = "With your first step, you know this was a bad idea. You hear a slight splashing noise, and look down to see a small puddle. No reason to worry. But as you continue, you begin to notice a thin layer of water dampening the soles of your shoes. And the water keeps rising. Soon you’re wading through it, slowing your forward progress to a crawl. You’re not sure where it’s coming from, but it’s an inconvenience nonetheless.  Also, you don’t know how to swim. That might be a problem."
main_castle_stealth_2 = "You slosh through the water for as long as you can until it threatens to envelop you entirely. Your breath comes in small, panicked spurts, and then not at all. Is this the moment you die? You kick your feet at the canyon floor to lift your head for one last glimpse at the world, and instead spot a miracle. A dead tree branch, floating languidly on the water’s surface. You reach for it and barely manage to hold on."
main_castle_stealth_3 = "You propel yourself to the end of the ravine by kicking your legs out behind you, and it is a such a relief once you stand upon solid ground again. There is still the dragon to fight, of course, but you expunge the thought from your mind until you stand before the doors of the castle."

main_castle_strength_1 = '''With your first step, you know this was a bad idea. The night seems even darker from inside the ravine, everything cast in shadows that lurk and linger with a menacing import. But even worse is when the weather-worn stone walls tower their highest above you, blotting out every source of brightness. You don’t want to admit it, but you might be a little scared of the dark. Also, you keep bumping into boulders and tripping over small rocks that litter the canyon floor.'''
main_castle_strength_2 = '''When you finally make it out, you attend to your numerous scrapes and gashes. You turn back to look at the geographical feature that has caused you so much turmoil, and from here, you feel a little foolish for being so weak. You also feel a little lightheaded, having lost a lot of blood, but after a short rest, you stagger the rest of the way to the castle, stopping right before its grand doors.'''

main_castle_m_1 = "With your first step, you know this was a bad idea. Nothing bad has occurred yet, but you’re pretty sure something will. Things are too oddly sanguine for the first few minutes, but then a loud crashing noise shatters the fraught silence. You crane your head over your shoulder to investigate. A massive boulder sits squarely where you were standing just a moment ago, and you say a thousand thanks that you left the tavern when you did, that you weren’t walking any slower."
main_castle_m_2 = "But you must be on your guard now, for what happened once can happen again. You scan the tops of the canyon walls for any more plummeting rocks, and spot a shadowy figure. Someone must have followed you from the tavern. You watch detachedly as he pushes another boulder to the edge of the ravine. Then you realize it’s meant for you. Meant to kill you. You break into a run, narrowly dodging rocks of all sizes that are hurled at you. "
main_castle_m_3 = "One grazes your shoulder painfully, and you want to collapse right there. You’re bleeding and out of breath, but you keep sprinting, out of the canyon and onwards to the castle. Whoever is trying to kill you will not succeed, not today or ever. You reach the castle, and, looking around to ensure the man is nowhere near, sit down in front of its grand doors. You just need a moment to tend to your wound. And catch your breath."
...
stealth_dragon1p1 = '''When it pauses for a second, you take out your dagger and launch it at the dragon’s underbelly. A line of blood appears where the dagger grazes, but unfortunately, ‘tis but a flesh wound. The dragon continues its blazing attacks, not weakened in the slightest. In another opportune moment, you take out your ninja star, your last weapon, and eye the glimmering chandelier. If your timing and aim is perfect, you might be able to bring the dragon down with it. Or you could aim the star directly at the dragon. What do you do? (chandelier(t)/dragon (b)?)'''

stealth_dragon_dragon = '''You carefully send the ninja star spinning towards the dragon’s heart, but the beast twists to
the left just as the weapon leaves your hand. The star glances harmlessly off its side and lands on the opposite side of the room. You stare at it helplessly, trembling with the knowledge that this is likely your final moment. It is. Though you try to dodge the next inferno sent your way, the last sensation you ever experience is that of being engulfed in flames. THE END.'''

stealth_dragon_chand = ''' You carefully aim the ninja star at the chain attaching the chandelier to the ceiling.
One link breaks, but that is all it takes for the decorative collection of glass shards to descend upon the dragon and send him crashing to the floor. You are in disbelief at what you’ve accomplished.'''
stealth_dragon_chand2 = '''There are so many coins littering the floor, and you shouldn’t let them go to waste, so you start gathering them up in your arms. Then the dragon awakens sluggishly. You startle, and coins spill everywhere. You start running before it gets the chance to kill you again, but stop when you realize that you can’t return to the tavern without proof of its death.'''
stealth_dragon_chand3= ''' Searching around, you spot an iridescent scale near the dragon, which you sprint to pick up before leaving. You can hear the dragon roaring even after you exit the castle, but thankfully it’s too weak to actually pursue you. '''

strength_dragon = ''' When you enter the cavernous chamber, you see the dragon asleep in the corner atop a pile of gold.
You could try killing it as it sleeps, but that seems dishonorable. You could also wake it up so that you can fight on equal terms, but that’s not an enticing option either. What do you do? (sleep(t)/wake(b)?'''

strength_dragon_sleep = '''  You creep towards the dragon, guilt rising within you. This really doesn’t seem like the right thing to do. As you get closer, you hold your sword in front of you, steadying yourself for the kill. Then the dragon cracks an eye open. You freeze, but don’t lower the sword. It lifts its head and startles you by speaking. “Don’t kill me,” it says calmly, its voice low and gravelly. “Why not?” you ask, trembling. “Many innocent people have perished because of you.” “True, but I could easily stop,” it replies. “And if you choose not to kill me, I might be convinced to.” '''

strength_dragon_sleep2 = ''' Something seems off—the dragon doesn’t seem as helpless as it’s acting—but you agree. The dragon shakes its head, causing an iridescent scale to fall loose. “Proof,” it says, and you could swear it’s smirking at you, “of your heroic deed.” You pick it up warily, nod at the dragon, and turn around to leave. You walk triumphantly out the castle, when suddenly the dragon swoops you up in its claws. It flies along the path you took to get here, and you figure the dragon wants to spare you of the long walk back.'''

strength_dragon_sleep3 = '''When you see the tavern below you, you realize that your mission will have been for nothing if the townspeople look up and see the dragon alive and well. “What are you doing?” you yell, trying to be heard over
...
magic_dragon = '''When you enter the cavernous chamber, the dragon sits upright and fixes you to your spot with its unnerving stare, as though it has been waiting for you all this time. The situation is doing nothing to soothe your frayed nerves. You spent the entire journey stewing in terrified anticipation—you’re not ready to die, but your magic powers are so erratic and uncontrollable that you wish you had something else to rely on. '''
...
magic_dragon_fight = '''You decide to stand your ground and keep your promise to your savior. If you die, it will be with honor. The dragon takes flight, circling the room from above. It sends ferocious spurts of fire at you that you manage to dodge. One blast comes especially close, singeing your clothes and skin. But now you can feel the magic surging in your veins now, powerful and impatient; the intense danger of that moment must have triggered its return from dormancy.  '''
...
You approach the dragon tentatively, not sure whether it’s dead or merely unconscious. As you get closer, you can see clearly that it remains still, its belly not swelling with the intake of breath. '''

magic_dragon_fight3 = ''' An almost tangible wave of guilt hits you at having ended the life of a magnificent beast with one swift blow. You push that sentiment aside and pick up a single scale as proof of what you did. You look at the dragon one last time, then turn away with a heavy heart and begin the journey back.'''

magic_dragon_flee = '''  You turn around and run away. You really can’t do this. That man back at the tavern may have saved you, but he had no right to ask this of you. Once outside of the castle, you see the very person you were silently berating. “Hello,” he says, sounding very much like a cat toying with its prey. '''
magic_dragon_flee2 = '''“What are you doing here?” you ask, indignant. If he followed you all the way here, why couldn’t he have helped you kill the dragon? His next words sting. “Forgive me if I didn’t trust you to complete this mission. And as you can see, I was right.” “Then why ask me at all?” “You see, this was a test. I am a wizard, and I was hoping to find a honorable apprentice in you,” he says. “Really?” you ask, taken aback.'''
magic_dragon_flee3 = '''He smirks. “No.” He takes out a gleaming dagger and strikes a fatal blow to your person. THE END. (PRESS X TO EXIT GAME)'''

manip_dungeon = ''' When you enter the cavernous chamber, the dragon sits upright and fixes you to your spot with its unnerving stare,as though it has been waiting for you all this time. The situation is doing nothing to soothe your frayed nerves. You’ve spent the entire journey stewing in terrified anticipation, and to have this moment upon you now is nothing short of overwhelming. Your only weapons are your words and your dagger, and though neither seem suited to this situation, they’re all you have. '''

manip_dungeon2 = '''“Who are you?” the dragon tries to snarl in an oddly high-pitched voice. You suppress nervous laughter and quickly formulate a response. You see two viable options: intimidation or ingratiation. Which do you choose? (intimidation(t)/ingratiation(b)?)'''

manip_dungeon_intim = '''“I am a renowned dragon slayer,” you say sonorously. “And if you refuse to cease inflicting injury after injury upon the poor town nearby, I would advise you to prepare for your end.” You expect the dragon to say something, anything, but it just stands there, impassive. '''
...
manip_dungeon_integ = ''' “I’m a huge fan of yours!” you exclaim, with as much enthusiasm as you can muster for a murderer. “I admire the way you can raze a village with a single fiery exhale, how you upend lives with such ease. So I wanted to meet you in person.” Hopefully your words paint you as a slightly crazed devotee and not a sycophant. “Is that right?” says the dragon, sounding flattered. “Well, thank you!” Is your crazy scheme actually working?'''
manip_dungeon_integ2 = '''“Of course! But you know what? There’s a tavern nearby where they don’t appreciate your work quite as much, and as someone who wants the best for you, I would humbly suggest that you take your art elsewhere.” You hold your breath, wishing for the best. “I suppose you might be right,” the dragon says after a moment. “Wonderful! I promise you won’t regret it,” you say. “Oh, and before I leave, I wonder if I might have one of your lovely iridescent scales as a souvenir?” As proof of its “death.” '''
manip_dungeon_integ3 = '''It agrees easily, scattering a few loose with a shake of its head. You pick one up and thank the dragon vigorously, then exit the castle after exchanging a few pleasantries. You feel a bit sleazy for deceiving the dragon, especially because it seems so lonely, but that doesn’t diminish how happy you are that you achieved your mission without any killing.''' 

main_return= '''After a long, arduous trip back from the castle, during which you decide that nothing can make you pass through that valley again, you arrive back at the tavern that has caused you so much misery, hopefully for the last time.''' 
